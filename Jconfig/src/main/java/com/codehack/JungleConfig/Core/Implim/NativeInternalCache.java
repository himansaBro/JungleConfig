...
public class NativeInternalCache implements InternalCacheInterface{
    ...
    public NativeInternalCache(ConverterInterface converter, int MAX_WRITES_MARGE, int MAX_READS_MARGE,boolean useCache) {
    ...
    private TypeMap<String,String,String> getCache(){
        if (!useCache) return converter.decode();
    ...
    private TypeMap<String,String,String> getUpdatedCache(TypeMap<String,String,String> saveQuery,List<String> remList){
