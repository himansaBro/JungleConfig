...
public class NativeConverter implements ConverterInterface {
    ...
    public TypeMap<String, String, String> decode() {
        ...
        if(data.isBlank()) return new TypeMap<String,String,String>();
        if (!data.startsWith("JConfig001")) throw new InvalidConfigFormatException();
    ...
    public void encode(TypeMap<String, String, String> data) {
        ...
        for (TypeMap.Entry<String,String,String> dt:data.getEntryList()){
            ...
            sb.append(dt.getKey()).append(":").append(dt.getValue1()).append("=").append(URLEncoder.encode(dt.getValue2(),StandardCharsets.UTF_8));
